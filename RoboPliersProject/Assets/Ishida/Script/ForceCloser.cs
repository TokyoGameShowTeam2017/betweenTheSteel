...
public class ForceCloser : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if ((Input.GetKey(KeyCode.JoystickButton6) && Input.GetKey(KeyCode.JoystickButton7)) || Input.GetKeyDown(KeyCode.Space))
            {
                GameObject obj = GameObject.Find("PlayerTutorial");
                GameObject.Destroy(obj);
                GameObject.Destroy(GameObject.Find("SceneLoadArea"));
